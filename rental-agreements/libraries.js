...
(function(){
  ...
  _.extend(History.prototype, Events, {
    ...
    getFragment: function(fragment, forcePushState) {
      ...
      fragment = fragment.replace(multiSlashStripper, '/');
...
define("hamlcoffee", function(){});

(function() {
  require(['requirelib', 'underscore', 'jquery', 'backbone', 'hamlcoffee'], function() {});
